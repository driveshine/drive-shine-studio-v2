    ...
    <div className="bg-white">
      ...
      <section className="pt-28 pb-12 bg-white">
        <div className="shell">
          ...
          <p className="mt-1 text-gray-500 mb-2">One simple fee — based on your car type. No hidden charges.</p>
          <p className="font-display text-xl font-bold text-ink">DRIVE SHINE PDI — Starts at ₹1,999</p>
          ...
          <div className="grid gap-8 lg:grid-cols-2 items-center">
            ...
            <div className="rounded-2xl bg-red p-10 text-white flex flex-col gap-4">
              <span className="mono-label text-white/70">All Vehicles · Starting At</span>
              <div className="flex items-end gap-2">
                <span className="font-display text-7xl font-black leading-none">₹1,999</span>
                <span className="mono-label text-white/70 mb-2">onwards</span>
              </div>
